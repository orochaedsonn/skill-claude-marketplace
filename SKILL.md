...
| Anúncio pronto — Pulseira Riviera | `references/anuncio-pulseira-riviera.md` | Título, descrição e checklist prontos para a Pulseira Riviera Baguete |
...
- Usuário pede anúncio, copy ou checklist da Pulseira Riviera → `references/anuncio-pulseira-riviera.md`
